      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              onClick={() =>
                handleDemoLogin("customer@example.com", "customer123")
              }
              disabled={loading}
            ...
            <button
              onClick={() =>
                handleDemoLogin("employee@example.com", "employee123")
              }
              disabled={loading}
            ...
            <button
              onClick={() =>
                handleDemoLogin("superadmin@example.com", "superadmin123")
              }
              disabled={loading}
        ...
        <div className="flex justify-center space-x-4 mb-6">
          ...
          >
            <FaGoogle className="text-gray-700 text-xl" />
          </button>
          <button
            onClick={() =>
